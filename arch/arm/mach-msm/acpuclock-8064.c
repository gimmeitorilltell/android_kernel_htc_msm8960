...
static struct acpu_level tbl_PVS4_0_1512MHz[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   1025000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   1050000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   1075000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),   1100000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(5),   1125000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(5),   1150000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(5),   1162500 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(14),  1175000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(14),  1187500 },
...
static struct acpu_level tbl_PVS4_1_1512MHz[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   1012500 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   1025000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   1075000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),   1100000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(5),   1112500 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(5),   1125000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(5),   1137500 },
...
static struct acpu_level tbl_PVS4_2_1512MHz[] __initdata = {
	...
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(5),   1087500 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(14),  1100000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(14),  1125000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(14),  1150000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(14),  1162500 },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(14),  1175000 },
	{ 0, { 0 } }
};

static struct acpu_level tbl_PVS4_3_1512MHz[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   1000000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   1000000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   1000000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),   1000000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(5),   1050000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(5),   1062500 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(5),   1075000 },
...
static struct acpu_level tbl_PVS4_4_1512MHz[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   1000000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   1000000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   1000000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),   1000000 },
...
static struct acpu_level tbl_PVS4_5_1512MHz[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),    987500 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),    987500 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),    987500 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),   1000000 },
...
static struct acpu_level tbl_PVS4_7_1512MHz[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),    975000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),    975000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),    975000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),    975000 },
...
static struct acpu_level tbl_PVS4_8_1512MHz[] __initdata = {
	...
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(14),  1037500 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(14),  1050000 },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(14),  1062500 },
	{ 0, { 0 } }
};

static struct acpu_level tbl_PVS4_9_1512MHz[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),    950000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),    950000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),    950000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),    950000 },
...
static struct acpu_level tbl_PVS4_10_1512MHz[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),    950000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),    950000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),    950000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),    950000 },
...
static struct acpu_level tbl_PVS4_11_1512MHz[] __initdata = {
...
static struct acpu_level tbl_PVS4_12_1512MHz[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),    937500 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),    937500 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),    937500 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),    937500 },
...
static struct acpu_level tbl_PVS4_13_1512MHz[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),    925000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),    925000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),    925000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),    925000 },
...
static struct acpu_level tbl_PVS4_14_1512MHz[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   925000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   925000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   925000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),   925000 },
...
static struct pvs_table pvs_tables[NUM_SPEED_BINS][NUM_PVS] __initdata = {
	...
	[7][0] = { tbl_PVS4_0_1512MHz, sizeof(tbl_PVS4_0_1512MHz),    0 },
	[7][1] = { tbl_PVS4_1_1512MHz, sizeof(tbl_PVS4_1_1512MHz),    25000 },
	[7][2] = { tbl_PVS4_2_1512MHz, sizeof(tbl_PVS4_2_1512MHz),    25000 },
	[7][3] = { tbl_PVS4_3_1512MHz, sizeof(tbl_PVS4_3_1512MHz),    25000 },
	[7][4] = { tbl_PVS4_4_1512MHz, sizeof(tbl_PVS4_4_1512MHz),    25000 },
	[7][5] = { tbl_PVS4_5_1512MHz, sizeof(tbl_PVS4_5_1512MHz),    25000 },
	[7][6] = { tbl_PVS4_6_1512MHz, sizeof(tbl_PVS4_6_1512MHz),    25000 },
	[7][7] = { tbl_PVS4_7_1512MHz, sizeof(tbl_PVS4_7_1512MHz),    25000 },
	[7][8] = { tbl_PVS4_8_1512MHz, sizeof(tbl_PVS4_8_1512MHz),    25000 },
	[7][9] = { tbl_PVS4_9_1512MHz, sizeof(tbl_PVS4_9_1512MHz),    25000 },
	[7][10] = { tbl_PVS4_10_1512MHz, sizeof(tbl_PVS4_10_1512MHz), 25000 },
	[7][11] = { tbl_PVS4_11_1512MHz, sizeof(tbl_PVS4_11_1512MHz), 25000 },
	[7][12] = { tbl_PVS4_12_1512MHz, sizeof(tbl_PVS4_12_1512MHz), 25000 },
	[7][13] = { tbl_PVS4_13_1512MHz, sizeof(tbl_PVS4_13_1512MHz), 25000 },
	[7][14] = { tbl_PVS4_14_1512MHz, sizeof(tbl_PVS4_14_1512MHz), 25000 },
};
